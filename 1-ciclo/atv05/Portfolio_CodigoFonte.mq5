...
//|    Generated at 06/12/2024 02:37
//| 
//|    Backtested on BTCUSD / M15, 2023.11.01 - 2024.05.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Portfolio_60_149";
...
input int MACDMainChangesFast1 = 12;        //MACDMainChangesFast1
input int MACDMainChangesSlow1 = 26;        //MACDMainChangesSlow1
input int MACDMainChangesSmt1 = 9;        //MACDMainChangesSmt1
input double PriceEntryMult1 = 1.7;        //PriceEntryMult1
input int ExitAfterBars1 = 24;        //ExitAfterBars1
input double ProfitTarget1 = 2.9;        //ProfitTarget1
input double StopLoss1 = 0.7;        //StopLoss1
input int SMAPeriod1 = 72;        //SMAPeriod1
...
#define MACD_1 0     //iMACD(NULL,0, MACDMainChangesFast1, MACDMainChangesSlow1, MACDMainChangesSmt1, PRICE_CLOSE)
#define SMA_1 1     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_TYPICAL)
...
string sqStrategyName = "Portfolio [60.149]";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = changesDown(MACD_1, 1);

     ShortEntrySignal = changesUp(MACD_1, 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 2) - (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 3);
...
bool initIndicators(){
   ...
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainChangesFast1, MACDMainChangesSlow1, MACDMainChangesSmt1, PRICE_CLOSE);
