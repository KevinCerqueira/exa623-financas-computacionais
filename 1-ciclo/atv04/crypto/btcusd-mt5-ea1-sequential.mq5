...
input string CustomComment = "Btcusd_mt5_EA1_Sequential_opti";
...
input double ProfitTarget1 = 1.9;        //ProfitTarget1
input double StopLoss1 = 0.7;        //StopLoss1
input double TrailingStop1 = 60;        //TrailingStop1
...
string sqStrategyName = "EA1 - Sequential optimized";
