//+------------------------------------------------------------------+
//| EA2 - Optimization 0.8.586 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 05/23/2024 03:32
//| 
//|    Backtested on BTCUSD / M15, 2024.01.01 - 2024.05.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Btcusd_mt5_EA2_Opt._0_8_586";
...
input int LinRegBarOpensPrd1 = 9;        //LinRegBarOpensPrd1
input double PriceEntryMult1 = 1.61;        //PriceEntryMult1
input int ExitAfterBars1 = 2;        //ExitAfterBars1
input double ProfitTarget1 = 221;        //ProfitTarget1
input double StopLoss1 = 54.6;        //StopLoss1
input double TrailingStop1 = 80;        //TrailingStop1
input int SmallestRangePeriod1 = 19;        //SmallestRangePeriod1
...
input double MaxDistanceFromMarketPct = 0;   //Max distance %
...
#define LINEARREGRESSION_1 0     //iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd1, PRICE_CLOSE)
...
string sqStrategyName = "EA2 - Optimization 0.8.586";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(LINEARREGRESSION_1, 2+1));

     ShortEntrySignal = (sqOpen("NULL",0, 2) < sqGetIndicatorValue(LINEARREGRESSION_1, 2+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqHigh(NULL,0, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqLow(NULL,0, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", LinRegBarOpensPrd1, PRICE_CLOSE);
