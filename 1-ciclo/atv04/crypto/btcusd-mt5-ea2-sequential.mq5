...
input string CustomComment = "Btcusd_mt5_EA2_Sequential_opti";
...
input int LinRegBarOpensPrd1 = 14;        //LinRegBarOpensPrd1
input double PriceEntryMult1 = 2.3;        //PriceEntryMult1
input int ExitAfterBars1 = 4;        //ExitAfterBars1
input double ProfitTarget1 = 170;        //ProfitTarget1
input double StopLoss1 = 78;        //StopLoss1
input double TrailingStop1 = 80;        //TrailingStop1
input int SmallestRangePeriod1 = 14;        //SmallestRangePeriod1
...
string sqStrategyName = "EA2 - Sequential optimized";
