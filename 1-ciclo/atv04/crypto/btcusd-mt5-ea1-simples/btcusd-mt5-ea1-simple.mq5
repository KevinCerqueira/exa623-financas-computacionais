...
input string CustomComment = "Btcusd_mt5_EA1_Opt._0_7_614";
...
input double PriceEntryMult1 = 0.89;        //PriceEntryMult1
input int ExitAfterBars1 = 40;        //ExitAfterBars1
input double MoveSL2BE1 = 175;        //MoveSL2BE1
input double ProfitTarget1 = 1.89;        //ProfitTarget1
input double StopLoss1 = 0.49;        //StopLoss1
input double TrailingStop1 = 42;        //TrailingStop1
input int ATRPeriod1 = 23;        //ATRPeriod1
...
#define MOVINGAVERAGE_1 0     //iMA(NULL,0, MAPeriod1, 0, MODE_LWMA, PRICE_WEIGHTED)
...
string sqStrategyName = "EA1 - Optimization 0.7.614";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsFalling(MOVINGAVERAGE_1, 2, false, 1);

     ShortEntrySignal = (sqGetIndicatorValue(MOVINGAVERAGE_1, 1+1)<sqGetIndicatorValue(MOVINGAVERAGE_1, 1));
...
bool initIndicators(){
   ...
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MAPeriod1, 0, MODE_LWMA, PRICE_WEIGHTED);
