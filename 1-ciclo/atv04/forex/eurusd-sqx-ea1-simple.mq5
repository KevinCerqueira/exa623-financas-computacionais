...
input string CustomComment = "Eurusd_sqx_ea1_simple";
...
input double PriceEntryMult1 = 1.12;        //PriceEntryMult1
input double ProfitTarget1 = 1.15;        //ProfitTarget1
input double StopLoss1 = 156;        //StopLoss1
input double TrailingStopCoef1 = 3.31;        //TrailingStopCoef1
input int SmallestRangePeriod1 = 28;        //SmallestRangePeriod1
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.10)
#define PARABOLICSAR_2 1     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 180)
...
string sqStrategyName = "eurusd-sqx-ea1-simple";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetBid("NULL") > sqGetIndicatorValue(PARABOLICSAR_1, 1));

     ShortEntrySignal = (sqGetBid("NULL") < sqGetIndicatorValue(PARABOLICSAR_2, 1));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 7);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 180);
