//+------------------------------------------------------------------+
//| eurusd-sqx-ea2-simple EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 05/23/2024 03:46
//| 
//|    Backtested on EURUSD(2) / M15, 2023.11.01 - 2024.05.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Eurusd_sqx_ea2_simple";
...
input int ATRLowerPeriod1 = 184;        //ATRLowerPeriod1
input int ExitAfterBars1 = 27;        //ExitAfterBars1
input double MoveSL2BE1 = 17;        //MoveSL2BE1
input double ProfitTarget1 = 87.5;        //ProfitTarget1
input double StopLoss1 = 56;        //StopLoss1
input int BollingerBandsPrd1 = 191;        //BollingerBandsPrd1
...
#define ATR_1 0     //iCustom(NULL,0, "SqATR", ATRLowerPeriod1)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.4, PRICE_OPEN)
...
string sqStrategyName = "eurusd-sqx-ea2-simple";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqGetIndicatorValue(ATR_1, 2) < 85.01;

     ShortEntrySignal = sqGetIndicatorValue(ATR_1, 2) < 85.01;
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 9);
...
bool initIndicators(){
   ...
   indicatorHandles[ATR_1] = iCustom(NULL,0, "SqATR", ATRLowerPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.4, PRICE_OPEN);
