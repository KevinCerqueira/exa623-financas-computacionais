...
input string CustomComment = "Strategy_0_64142";
...
input int KCBarOpnAftOpnPrd1 = 41;        //KCBarOpnAftOpnPrd1
input double PriceEntryMult1 = 0.6;        //PriceEntryMult1
input double MoveSL2BE1 = 140;        //MoveSL2BE1
input double ProfitTarget1 = 295;        //ProfitTarget1
input double StopLoss1 = 103.3;        //StopLoss1
input int BiggestRangePeriod1 = 10;        //BiggestRangePeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 0.3)
...
string sqStrategyName = "Strategy 0.64142";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 1+1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true) && sqOpen("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 2) - (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpnAftOpnPrd1, 0.3);
