...
input string CustomComment = "Strategy_0_3023";
...
input double InitialCapital = 2000; //InitialCapital (0 means whole account balance). Used in some MM methods.
...
input string SignalTimeRangeTo = "18:00";
...
string sqStrategyName = "Strategy 0.3023";
